            ...
            <div className="mx-auto shadow">
              <div className="px-4 xl:px-8 lg:px-8 md:px-8 sm:px-8">
                <div>
                  ...
                  {question === 0 && (
                    <div
                      className={`h-full py-4 overflow-y-scroll xl:py-8 lg:py-8 md:py-8 sm:py-8 ${styles.listContainer}`}
                    >
                      <h2>
                        <strong>Terms and Conditions</strong>
                      </h2>

                      <p>Welcome to Shoppalog!</p>

                      <p>
                        These terms and conditions outline the rules and
                        regulations for the use of Shoppalog's Website, located
                        at www.Shoppalog.com.
                      </p>

                      <p>
                        By accessing this website we assume you accept these
                        terms and conditions. Do not continue to use Shoppalog
                      ...
                      <p>
                        We employ the use of cookies. By accessing Shoppalog,
                        you agreed to use cookies in agreement with the
                        Shoppalog's Privacy Policy.{" "}
                      </p>
                      ...
                      <p>
                        Unless otherwise stated, Shoppalog and/or its licensors
                        own the intellectual property rights for all material on
                        Shoppalog. All intellectual property rights are
                        reserved. You may access this from Shoppalog for your
                      ...
                      <p>You must not:</p>
                      <ul>
                        <li>Republish material from Shoppalog</li>
                        <li>
                          Sell, rent or sub-license material from Shoppalog
                        </li>
                        <li>
                          Reproduce, duplicate or copy material from Shoppalog
                        </li>
                        <li>Redistribute content from Shoppalog</li>
                      </ul>
                      ...
                      <p>
                        Shoppalog reserves the right to monitor all Comments and
                      ...
                      <p>
                        You hereby grant Shoppalog a non-exclusive license to
                      ...
                      <p>
                        ...
                        Shoppalog; and (d) the link is in the context of general
                      ...
                      <p>
                        ...
                        you must inform us by sending an e-mail to Shoppalog.
                      ...
                      <p>
                        No use of Shoppalog's logo or other artwork will be
